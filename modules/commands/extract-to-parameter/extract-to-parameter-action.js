...
function extractToParameter() {
    ...
    return asyncPrepareActionSetup()
        ...
        .then((variableDeclarator) => validateUserInput({
            ...
            message: buildInfoMessage('No variable selected; cannot extract parameter')
        }))
        ...
        .then((functionNode) => validateUserInput({
            ...
            message: buildInfoMessage('Variable is not within a function scope; cannot extract parameter')
        }))
